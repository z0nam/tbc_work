...
PRODUCTIVITY_QUESTIONS = [
    "<일주일 전 근무일과 비교하여> 가장 최근 근무일(정규근무시간 중)에 귀하가 수행한 '업무량'은 어느 정도였다고 생각하십니까?",
    "<일주일 전 근무일과 비교하여> 가장 최근 근무일 (정규근무시간 중)에 귀하가 수행한 '업무의 질'은 어느 정도였다고 생각하십니까?",
    "<한달 전 근무일과 비교하여> 가장 최근 근무일 (정규근무시간 중)에 귀하가 수행한 '업무량'은 어느 정도 였다고 생각하십니까?",
    "<한달 전 근무일과 비교하여> 가장 최근 근무일 (정규근무시간 중)에 귀하가 수행한 '업무의 질'은 어느 정도였다고 생각하십니까?",
    "<6개월 전 근무일과 비교하여> 가장 최근 근무일 (정규근무시간 중)에 귀하가 수행한 '업무량'은 어느 정도 였다고 생각하십니까?",
    "<6개월 전 근무일과 비교하여> 가장 최근 근무일 (정규근무시간 중)에 귀하가 수행한 '업무의 질'은 어느 정도였다고 생각하십니까?",
]
